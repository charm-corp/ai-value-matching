    ...
    options: [
      {
        value: 'family',
        text: '가족과의 시간',
        weights: { family: 5, stability: 3, relationships: 4 },
      },
      { value: 'growth', text: '성장과 도전', weights: { growth: 5, adventure: 3, career: 4 } },
      {
        value: 'stability',
        text: '안정과 평화',
        weights: { security: 5, stability: 4, health: 3 },
      },
      {
        value: 'freedom',
        text: '자유와 독립',
        weights: { freedom: 5, adventure: 4, creativity: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'quiet',
        text: '조용한 곳에서 독서나 명상',
        weights: { spirituality: 4, growth: 3, health: 3 },
      },
      {
        value: 'social',
        text: '친구들과 함께 활동',
        weights: { relationships: 5, extroversion: 4, social: 5 },
      },
      {
        value: 'active',
        text: '운동이나 야외활동',
        weights: { health: 5, adventure: 4, active: 5 },
      },
      {
        value: 'creative',
        text: '예술이나 창작활동',
        weights: { creativity: 5, growth: 3, artistic: 4 },
      },
    ],
  },
  {
    ...
    options: [
      { value: 'logic', text: '논리적 분석', weights: { analytical: 5, conscientiousness: 4 } },
      {
        value: 'emotion',
        text: '감정과 직감',
        weights: { emotional: 5, empathy: 4, agreeableness: 3 },
      },
      {
        value: 'others',
        text: '주변 사람들의 의견',
        weights: { relationships: 4, agreeableness: 5 },
      },
    ...
    options: [
      {
        value: 'home',
        text: '집에서 편안하게',
        weights: { security: 4, stability: 5, introversion: 3 },
      },
      {
        value: 'adventure',
        text: '새로운 곳 탐험',
        weights: { adventure: 5, openness: 4, extroversion: 3 },
      },
      {
        value: 'friends',
        text: '친구들과 모임',
        weights: { relationships: 5, extroversion: 4, agreeableness: 3 },
      },
      {
        value: 'family',
        text: '가족과 함께',
        weights: { family: 5, relationships: 4, stability: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'direct',
        text: '직접적으로 대화',
        weights: { extroversion: 4, conscientiousness: 3 },
      },
      ...
      { value: 'mediate', text: '중재자를 통해', weights: { agreeableness: 5, relationships: 4 } },
      {
        value: 'compromise',
        text: '타협점을 찾음',
        weights: { agreeableness: 4, conscientiousness: 4 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      { value: 'flexible', text: '유연한 방향성', weights: { openness: 4, adaptability: 5 } },
      {
        value: 'goals',
        text: '목표 중심',
        weights: { career: 5, growth: 4, conscientiousness: 3 },
      },
    ...
    options: [
      {
        value: 'security',
        text: '안정과 저축이 중요',
        weights: { security: 5, conscientiousness: 4, stability: 4 },
      },
      {
        value: 'experience',
        text: '경험에 투자',
        weights: { adventure: 4, growth: 5, openness: 4 },
      },
      {
        value: 'sharing',
        text: '나눔과 기부',
        weights: { agreeableness: 5, spirituality: 4, relationships: 3 },
      },
    ...
    options: [
      {
        value: 'active',
        text: '적극적인 운동',
        weights: { health: 5, conscientiousness: 4, active: 5 },
      },
      {
        value: 'balanced',
        text: '균형잡힌 생활',
        weights: { health: 4, conscientiousness: 3, stability: 4 },
      },
      {
        value: 'natural',
        text: '자연스러운 관리',
        weights: { health: 3, spirituality: 4, openness: 3 },
      },
      {
        value: 'medical',
        text: '의학적 접근',
        weights: { health: 4, conscientiousness: 5, security: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'excited',
        text: '설레고 즐겁다',
        weights: { extroversion: 5, openness: 4, optimism: 5 },
      },
      {
        value: 'curious',
        text: '호기심이 생긴다',
        weights: { openness: 5, intellectualCuriosity: 4, growth: 3 },
      },
      {
        value: 'cautious',
        text: '조심스럽다',
        weights: { neuroticism: 3, conscientiousness: 4, security: 3 },
      },
      {
        value: 'comfortable',
        text: '편안하다',
        weights: { extroversion: 4, agreeableness: 4, emotionalStability: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'exercise',
        text: '운동이나 신체활동',
        weights: { health: 5, active: 5, emotionalStability: 3 },
      },
      {
        value: 'social',
        text: '사람들과 대화',
      ...
      },
      {
        value: 'alone',
        text: '혼자만의 시간',
        weights: { introversion: 4, spirituality: 3, security: 3 },
      },
    ...
    options: [
      {
        value: 'planned',
        text: '계획적인 여행',
        weights: { conscientiousness: 5, security: 3, organization: 4 },
      },
      {
        value: 'spontaneous',
        text: '즉흥적인 여행',
        weights: { openness: 5, adventure: 5, spontaneity: 4 },
      },
      { value: 'comfort', text: '편안한 여행', weights: { security: 4, stability: 4, comfort: 5 } },
      {
        value: 'cultural',
        text: '문화 체험 중심',
        weights: { intellectualCuriosity: 5, growth: 4, openness: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'trust',
        text: '신뢰와 솔직함',
        weights: { relationships: 5, agreeableness: 4, honesty: 5 },
      },
      {
        value: 'support',
        text: '서로 지지해주기',
        weights: { relationships: 5, agreeableness: 5, empathy: 4 },
      },
      {
        value: 'fun',
        text: '즐거운 시간 공유',
        weights: { relationships: 4, extroversion: 4, optimism: 4 },
      },
      {
        value: 'understanding',
        text: '깊은 이해',
        weights: { relationships: 5, empathy: 5, intellectualCuriosity: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'balance',
        text: '완전한 균형이 중요',
        weights: { health: 4, stability: 4, conscientiousness: 3 },
      },
      {
        value: 'work_first',
        text: '일의 성취가 우선',
        weights: { career: 5, growth: 4, conscientiousness: 4 },
      },
      {
        value: 'life_first',
        text: '개인 시간이 더 중요',
        weights: { freedom: 4, health: 4, relationships: 3 },
      },
      {
        value: 'flexible',
        text: '상황에 따라 유연하게',
        weights: { adaptability: 5, openness: 4, pragmatism: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'systematic',
        text: '체계적 분석',
        weights: { conscientiousness: 5, analytical: 5, methodical: 4 },
      },
      {
        value: 'creative',
        text: '창의적 해결',
        weights: { creativity: 5, openness: 5, innovation: 4 },
      },
      {
        value: 'collaborative',
        text: '협력적 접근',
        weights: { relationships: 5, agreeableness: 4, teamwork: 5 },
      },
      {
        value: 'intuitive',
        text: '직관적 판단',
        weights: { intuition: 5, openness: 3, confidence: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'outgoing',
        text: '외향적이고 활발함',
        weights: { extroversion: 5, optimism: 4, energy: 5 },
      },
      {
        value: 'thoughtful',
        text: '사려깊고 신중함',
        weights: { conscientiousness: 4, intellectualCuriosity: 4, wisdom: 5 },
      },
      {
        value: 'optimistic',
        text: '긍정적이고 밝음',
        weights: { optimism: 5, emotionalStability: 4, resilience: 4 },
      },
      {
        value: 'calm',
        text: '차분하고 안정적',
        weights: { emotionalStability: 5, stability: 4, peaceful: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'continuous',
        text: '지속적인 학습',
        weights: { growth: 5, intellectualCuriosity: 5, openness: 4 },
      },
      {
        value: 'practical',
        text: '실용적 지식 위주',
        weights: { pragmatism: 5, conscientiousness: 3, efficiency: 4 },
      },
      {
        value: 'deep',
        text: '깊이 있는 탐구',
        weights: { intellectualCuriosity: 5, growth: 4, depth: 5 },
      },
      {
        value: 'experiential',
        text: '경험을 통한 학습',
        weights: { adventure: 4, openness: 4, hands_on: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'clarity',
        text: '명확한 표현',
        weights: { conscientiousness: 4, directness: 5, clarity: 5 },
      },
      {
        value: 'empathy',
        text: '공감과 이해',
        weights: { empathy: 5, agreeableness: 5, emotional_intelligence: 4 },
      },
      { value: 'humor', text: '유머와 재미', weights: { extroversion: 4, optimism: 4, humor: 5 } },
      {
        value: 'respect',
        text: '상호 존중',
        weights: { agreeableness: 5, respect: 5, dignity: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'embrace',
        text: '적극적으로 수용',
        weights: { openness: 5, adaptability: 5, adventure: 4 },
      },
      {
        value: 'cautious',
        text: '신중하게 접근',
        weights: { conscientiousness: 4, security: 3, careful: 4 },
      },
      {
        value: 'gradual',
        text: '점진적으로 적응',
        weights: { stability: 4, conscientiousness: 3, methodical: 3 },
      },
      {
        value: 'resistant',
        text: '기존 방식 선호',
        weights: { security: 5, stability: 5, traditional: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'relationships',
        text: '인간관계에서',
        weights: { relationships: 5, family: 4, agreeableness: 4 },
      },
      {
        value: 'achievement',
        text: '성취와 목표 달성',
      ...
      },
      {
        value: 'service',
        text: '타인에 대한 봉사',
        weights: { spirituality: 5, agreeableness: 5, altruism: 5 },
      },
      {
        value: 'growth',
        text: '개인적 성장',
        weights: { growth: 5, intellectualCuriosity: 4, self_awareness: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'companion',
        text: '인생의 동반자',
        weights: { relationships: 5, family: 4, stability: 4, companionship: 5 },
      },
      {
        value: 'best_friend',
        text: '가장 친한 친구',
        weights: { relationships: 5, agreeableness: 4, friendship: 5, fun: 4 },
      },
      {
        value: 'soulmate',
        text: '영혼의 짝',
        weights: { relationships: 5, spirituality: 4, deep_connection: 5, romantic: 5 },
      },
      {
        value: 'team',
        text: '최고의 팀',
        weights: { relationships: 4, cooperation: 5, shared_goals: 5, partnership: 5 },
      },
    ],
  },
];
...
router.post(
  ...
  async (req, res) => {
    try {
            ...
            if (selectedOption.weights) {
              Object.entries(selectedOption.weights).forEach(([trait, weight]) => {
                ...
                if (personalityScores.hasOwnProperty(trait)) {
                  personalityScores[trait] = Math.min(
                    100,
                    (personalityScores[trait] || 50) + weight
                  );
                }
      ...
      res.json({
        success: true,
        message: assessment.isCompleted
          ? '가치관 평가가 완료되었습니다!'
          : '답변이 저장되었습니다.',
        data: {
          assessment: {
...
router.get('/assessment/:id', authenticate, validateObjectId('id'), async (req, res) => {
  try {
    const assessment = await ValuesAssessment.findById(req.params.id).populate(
      'userId',
      'name age'
    );
...
router.post('/compatibility', authenticate, async (req, res) => {
  try {
    ...
    const compatibility = {
      ...
      breakdown: {
        values: calculateValuesSimilarity(
          myAssessment.valueCategories,
          targetAssessment.valueCategories
        ),
        personality: calculatePersonalitySimilarity(
          myAssessment.personalityScores,
          targetAssessment.personalityScores
        ),
